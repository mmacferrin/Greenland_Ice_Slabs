...
Specifically for MacFerrin, et. al. (2016?), "[Insert Title Here]"
...
DROPBOX_PAPER_FOLDER = r'C:\Users\mmacferrin\Dropbox\Research\Papers\MacFerrin et al 2016 - IceBridge Lenses'
DROPBOX_DATA_FOLDER = os.path.join(DROPBOX_PAPER_FOLDER, 'Data')
DROPBOX_FIGURES_FOLDER = os.path.join(DROPBOX_PAPER_FOLDER, "Figures")
...
# TODO: Fix Folder names
ASCII_DIR = os.path.join(GPR_DIR, r'2013 Processed REFLEXW\ASCII')
...
# Firn Cores
CORE_FOLDER = os.path.join(DROPBOX_DATA_FOLDER, 'Cores')
CORE_XLSX_FILE = os.path.join(CORE_FOLDER, r'firn_cores_2009_2012_2013_2015_2016_temp.xlsx')
